...
(
	...
	echo "CREATE USER prj_$NAME_fotos@localhost IDENTIFIED BY '$PASSWORD_KNFOTOS';"
	echo "CREATE DATABASE prj_$NAME_fotos;"
	echo "GRANT ALL PRIVILEGES ON prj_$NAME_fotos.* TO prj_$NAME_fotos@localhost;"
) | mysql
